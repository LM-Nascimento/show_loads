...
class LoadsDecorator:
    ...
    def install(self, context):
        if self.is_installed:
            self.uninstall()
        handler = self()
        self.handlers.append(SpaceView3D.draw_handler_add(handler.draw_load_values, ((context,)), "WINDOW", "POST_PIXEL"))
        ...
        #)
        self.handlers.append(SpaceView3D.draw_handler_add(handler, (), "WINDOW", "POST_VIEW"))
        self.linear_load_shader = ShaderInfo("DistributedLoad")
    ...
    def update(self, context):
        self.linear_load_shader.update()
        self.text_info += self.linear_load_shader.text_info
